...
class Mysql:
    ...
    def get(self):
        self.__query = '''
            ...
            left join `topic` t on dm.topic_id=t.topic_id
            ...
            left join `data_column_map` dcmap on dm.data_map_id=dcmap.data_map_id
            left join `table_column` sccol on dcmap.source_column_id=sccol.table_column_id
            left join `table_column` dtcol on dcmap.source_column_id=dtcol.table_column_id
        '''
